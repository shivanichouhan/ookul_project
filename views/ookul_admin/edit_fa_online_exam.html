...
$b=explode('/',$a);
 $_GET['id']=$b['5'];
 $que=$obj->fetchById($_GET['id'],"fa_multiple_question","id");
 ?>
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1> Free Access Practise Question And Answer </h1>
                                <small>Free Access Question <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="gove_mlutipal_question_list.php"> Free Access  Practise Question List</a></li>
                                    <li class="active"> Free Access Practise Question</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Free Access Practise Question Answer</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                    <form data-toggle="validator" action="<?php echo $base1; ?>edit_fa_online_exam_sub"  enctype="multipart/form-data" method="post">
...
<div class="form-group">
    <label for="inputName" class="control-label">Answer</label>
		...
		<option <?php if($que['answer']=='4') { ?> selected="selected" <?php } ?> value="4">Question4</option>
											  ...
											  <div class="form-group">
     <label for="inputName" class="control-label">Question</label>
        <input type="file" class="form-control" id="inputName" name="question_image" placeholder="question" value="<?php echo $que['question_image']; ?>">
</div>
<div class="form-group">
    <label for="inputName" class="control-label">option(1)</label>
...
<div class="form-group">
    <label for="inputName" class="control-label">Solution</label>
    <input type="file" class="form-control" id="inputName" name="soluction_img" placeholder="soluction_img" value="<?php echo $que['soluction_img']; ?>">
</div>
