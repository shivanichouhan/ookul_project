...
include"menu.php"; 
$rs007=$obj->fetchById($_GET['id'],"days","id");
?>
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Days </h1>
                                <small>Edit Days <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="edit_days_sub.php" method="post">
										 <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                           
									
										<div class="form-group">
                                                <label for="inputName" class="control-label">Days  </label>
                                                <input type="text" class="form-control" id="inputName" name="days" placeholder="days" value="<?php echo $rs007['days']; ?>">
											</div>
											<!--<div class="form-group">
