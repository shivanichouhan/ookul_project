...
include"menu.php"; ?> <!-- /. main header -->
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="ca_subject">Add Subject</a></li>
												...
												<?php
                                                    ...
                                                    <tr>
														   ...
														   <td><?php echo $row['subject_name']; ?></td>
														    <td>
														        <?php if( $row['image']=='') {  ?>
												<img src="gov_upload/nosubject.png" style="    width: 100px;   height: 100px;">
  ...
  <ul class="dropdown-menu">
    <li><a href="ca_edit_gov_subject.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
   <li><a href="delete.php/<?php echo $row['id'];?>/current_affairs_subject/id/ca_subject_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
