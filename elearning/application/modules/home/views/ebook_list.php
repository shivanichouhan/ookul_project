...
<th class="table_t tabledata">Document View</th>
<th class="table_t tabledata">Document Type</th>
<th class="table_t tabledata">Action</th>
   ...
   <?php if (!empty($user))
         {                                                
                ...
                <td  style="color: blue !important;text-decoration: underline;" class="tabledata"><a target="_blank" href="<?php echo base_url('admin/upload/'.$value['images']); ?>">View</a></td>
                <td class="tabledata"><?= $type; ?></td>
                <td class="tabledata"><a href="<?= base_url('home/deleteebook/'.$value['id']); ?>" class="btn btn-danger" ><i class="fa fa-trash"></i></a></td>
                </tr>
