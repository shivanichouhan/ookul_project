...
class database
{
	...
	function insert_new_pdf_post($user_id,$img_title,$description,$imgname,$cat,$thumbnail)
	{ 
	    $date=date("d-m-Y");
     	$sql="insert into  pdf_posts(userid,pdf_title,descriptionss,pdf,date,category,thumbail)values('$user_id','$img_title','$description','$imgname','$date','$cat','$thumbnail')";  
	...
	function insert_new_audio_post($user_id,$img_title,$description,$imgname,$thumbnail,$category)
	{ 
	    $date=date("d-m-Y");
     	$sql="insert into  audio_posts(userid,audio_title,descriptionss,audio,date,thumbnail,category)values('$user_id','$img_title','$description','$imgname','$date','$thumbnail','$category')";  
     		$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
		if($rs)
			return mysqli_insert_id($this->link);
		else
	...
	function insert_new_video_post($user_id,$img_title,$description,$imgname,$thumbnail,$category)
	{ 
	    $date=date("d-m-Y");
     	$sql="insert into  video_posts(userid,video_title,descriptionss,videos,date,thumbnail,category)values('$user_id','$img_title','$description','$imgname','$date','$thumbnail','$category')";  
     		$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
		if($rs)
			return mysqli_insert_id($this->link);
		else
	...
	function update_user_todolist($todo_id,$status)
	{
		$sql="update Todolist set status=$status where todo_id='$todo_id' ";
		$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
	...
	function insert_new_images_post($user_id,$img_title,$description,$imgname)
	{ 
	    $date=date("d-m-Y");
     	$sql="insert into image_posts(userid,image_title,descriptionss,images,date)values('$user_id','$img_title','$description','$imgname','$date')";  
     		$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
		if($rs)
			return mysqli_insert_id($this->link);
		else
	...
	{ 
		...
		function insert_pdf_user_ebook_1_video($category,$user_id,$title,$tags,$date,$description,$pdfname,$imgname)
	{ 
	    
	    $date=date("d-m-Y");
     	$sql="insert into welcome_videos(category,user_id,title,tags,date,descrp,videos,thumbnail)values('$category','$user_id','$title','$tags','$date','$description','$pdfname','$imgname')";  
     	$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
		if($rs)
			return mysqli_insert_id($this->link);
		else
	...
	function allvideo()
	{
	  $sql="select * from welcome_videos where status = 2";
		...
		function trending_video()
	{
	  ...
	  $sql="select * from welcome_videos";
	...
	function userInsert_new($fname,$lname,$email,$phone,$password,$category,$picture,$dob,$address,$otp)
	{ 
	    $date=date("d-m-Y");
     	$sql="insert into register(fname,lname,email,phone,password,category,picture,dateofbirth,address,registrationdate,otp)values('$fname','$lname','$email','$phone','$password','$category','$picture','$dob','$address','$date',$otp)"; 
		$rs = mysqli_query($this->link, $sql) or die(mysqli_error($this->link));
		if($rs)
			return mysqli_insert_id($this->link);
		else
   ...
   // $date=date("d-m-Y");
	 ...
	 function fetchDetailById_todolist_1($id,$table,$field)
	{
		...
		if($rs)
		 ...
		 function fetchDetailById_todolist_12($id,$table,$field)
	{
...
//     }
	...
	function update_register11($fname,$lname,$email,$phone,$state,$city,$id)
	{
	   $sql = "update  `register` set `fname`='$fname',`lname`='$lname',`email`='$email',phone='$phone',`state`='$state',city='$city' where `id`='$id'"; 
		...
		function update_register11_picture($fname,$lname,$email,$phone,$state,$city,$id,$picture)
	{
	   $sql = "update  `register` set `fname`='$fname',`lname`='$lname',`email`='$email',phone='$phone', picture='$picture',`state`='$state',city='$city' where `id`='$id'"; 
