...
$response["current_affaire"] = array();
...
if($user_id=='')
{
      $response["error"] =true;
        ...
        @array_push($response["current_affaire"]);
        echo json_encode($response);
}
else
{
   
$rs11=$obj->fetchAllDetail("current_affaire_assigment"); 
if($rs11)
{
...
{ 
 ...
 $da;
    ...
    if($rs1145['days']<=$da)
    {
        ...
        $response["success"] =1;
        $response["msg"] = "Current Affaire day wise";
       $info["id"]=$row11['id'];
        ...
        @array_push($response["current_affaire"],$info);
    }
