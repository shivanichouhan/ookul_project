...
else
{
    ...
    {
   $exam_cal=0;
    $rs7=$obj->fetchDetailByIdByStatus00($examid,"question_answer_gov","exam_type_id","user_id",$user_id);
    if($rs7)
            {
    ...
    //  die();
       ...
       $demo=$exam_cal*$settotal; 
            $rs=$obj->fetchDetailByIdByStatusexampractis55555($sub[$su1],"`gover_multiple_question`","`subject`","exam_type",2,"exam_type_id",$examid,$settotal,$demo);
            if($rs)
            {
