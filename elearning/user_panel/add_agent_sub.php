...
$rs=$obj->insertagent0021($name,$email,$password,$mobile,$amount,$block_supervisor_id,$address,$adhar_no,$account_holder_name,$account_number,$ifc_code,$branch_name,$img,$img1);
if($rs)
{
