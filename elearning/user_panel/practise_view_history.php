...
$use=$obj->fetchById($user_id,"user_register_goverment","id");
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1> Practise Exam User <?php echo $use['name']; ?></h1>
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												//	$table='user_register_goverment';
													$rs=$obj->fetchDetailById($user_id,"`question_answer_gov`","`user_id`");
													if($rs)
													{	$i=0;
													...
													<td><?php echo $exa['exam_name']; ?></td>
													
													<td><?php echo $row['date']; ?></td>
                                                   
													<td><a href="p_view_history_details.php?id=<?php echo $row['id'];  ?>&user_id=<?php echo $_GET['user_id']; ?>&exam_type_id=<?php echo $row['exam_type_id']; ?>">View History</a></td>
