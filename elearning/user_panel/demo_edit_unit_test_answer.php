...
$op=$obj->fetchById($_GET['id'],"unit_test_answer","id");
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Edit Demo Unit Test Question </h1>
                                <small>Edit Demo Answer<a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="unit_question_list">Unit Demo Test Answer List</a></li>
                                    <li class="active">Edit Demo Unit Test Answer</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Edit Demo Unit Test Answer</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="<?php echo $base1; ?>demo_edit_unit_test_answer_sub" method="post">
                                            ...
                                            <div class="form-group">
												...
												<input type="text" name="answer" class="form-control" value="<?php echo $op['answer'];  ?>">
