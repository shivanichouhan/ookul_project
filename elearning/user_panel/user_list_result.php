...
include"menu.php"; 
$exams1=$obj->fetchById($_GET['id'], "exam_names","id");?>
<style>
...
$rs=$obj->fetchAllDetailByIdByStatus($_GET['id'],"result","user_id",$_GET['user_id'],"exam_id");
...
// $rs1=$obj->fetchAllDetailById($_GET['id'],"result", "user_id");
...
?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['total_ques_attend'];?></td>
                                                        <td><?php echo $row['total_wrong_ques'];?></td>
                                                        <td><?php echo $row['total_neg_marking'];?></td>
                                                        <td><?php echo $row['total_marks_obtain'];?></td>
                                                        <td><?php echo $row['rank_obtain'];?></td>
                                                    </tr>
															<?php 
														}}
												 ?>
