...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Exam Update List</h1>
                                <small>List All Exam Update's</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="exam_update">Add Exam Update</a></li>
                                    <li class="active">Exam Update List</li>
                                </ol>
                            </div>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_exam_update.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/exam_update/id/exam_update_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
	<?php if($row['status']==1){?>
            ...
            <script>
                function change_update(a,b)
                {
                       var http=new XMLHttpRequest();
						...
						http.open("GET","exam_change_update.php?id="+a+"&status="+b,true);
						http.send();
                }
            </script>
