...
$ques=$obj->fetchById($_GET['id'],"demo_true_false","id");
$sub=$obj->fetchById($ques['subject'],"demo_subject","id");
$chap=$obj->fetchById($ques['chapter'],"demo_chapter","id");
 ?>
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="demo_true"> True False Question List</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="<?php echo $base1; ?>demo_edit_true_sub.php" method="post">
