...
$b=explode('/',$a);
 $_GET['id']=$b['5']; 
$con=$obj->fetchById($_GET['id'],"gov_subject","id"); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form action="<?php echo $base1; ?>edit_gov_subject_sub" method="post" enctype="multipart/form-data">
										 <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" >
									
										<div class="form-group">
                                                <label for="inputName" class="control-label">Subject  </label>
                                                <input type="text" class="form-control" id="inputName" name="subject" placeholder="subject" value="<?php echo $con['subject'];?>">
											</div>
											...
											<div class="form-group">
												...
												<div class="form-group">
                                                <label for="inputName" class="control-label">Banner Image </label>
                                                
                                                 <input type="file" class="form-control" id="exampleInputEmail1" name="banner_image" placeholder="image">
												<input type="hidden" class="form-control" name="blimg" value="<?php echo $con['banner_image'];?>">
