...
include"menu.php"; ?>
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Government Report/History</li>
                                </ol>
                            </div>
							<div class="header-title">
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Government Report History</h4>
                                        </div>
                                    </div>
   <div class="panel-body">
     ...
     <form  action="gove_date_filter.php" method="GET">
	 <div class="col-md-2">
...
<div class="col-md-1">
  ...
  while($rs=mysqli_fetch_assoc($row)){
   ...
   $row=$obj->fetchDetailById(@$_GET['date'],"user_register_goverment","success_date");
  if($row){
  while($rs=mysqli_fetch_assoc($row)){
	  $cit=$obj->fetchById($rs['city_id'],"city","id");
	  $block=$obj->fetchById($rs['block'],"block","id");
...
<div style='height: 80%; overflow: auto;' >
  ...
  while($rs=mysqli_fetch_assoc($row)){
      $i++;
      if(strtotime($rs['success_date'])<=strtotime($edate))
        												 {
            												if(strtotime($sdate)<=strtotime($rs['success_date']))
            												{ 
...
<?php 				}   else { ?>
												...
												?>
												 ...
												 <td><?php echo $cit['city']; ?></td>
													...
													background: #f64565;">Paid (<?php if($rs['payment_type']==1) { echo"online"; } ?> <?php if($rs['payment_type']==3) { echo"Coupan"; } ?> )</button>
														...
														<td><?php echo $rs['success_date']; ?></td>
 ...
 function clas(a){
				 //alert(a);
				 $("#user").load("city_gov_user.php?id="+a);
				  }
				  </script>
				   <script>
 function payment(a){
				 //alert(a);
				 $("#payment").load("gov_payment_type.php?id="+a);
				  }
				  </script>
 ...
 function block(a){
				 //alert(a);
				 $("#block").load("gov_block_userAjax.php?id="+a);
				  }
				  </script>
