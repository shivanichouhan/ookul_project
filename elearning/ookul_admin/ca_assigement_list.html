                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Current Affairs Assignment List</h1>
                                <small>Current Affairs Assignment   Online's</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="ca_assigement.php">Current Affairs Assignment  </a></li>
                                    <li class="active">Current Affairs Assignment   List</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Current Affairs Assignment   List</h4>
                                        </div>
                                    </div>
									...
									$op4=$obj->fetchById($row['subject'],"current_affairs_subject","id");
									$op5=$obj->fetchById($row['topic'],"ca_topic","id");
									...
									//$chap=$obj->fetchById($row['chapter'],"chapter","id");
													...
													<td><?php echo $op4['subject_name']; ?></td>
													<td><?php echo $op5['topic']; ?></td>
														   
<td><?php if($row['type']=='2'){ ?> <img src="gov_upload/<?php echo $row['question_image'] ?>" >
...
<img src="gov_upload/<?php echo $row['option_img12'] ?>" >
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_ca_assigement.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/ca_assigment/id/ca_assigement_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
