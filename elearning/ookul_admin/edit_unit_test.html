...
include"menu.php";
 ...
 $b=explode('/',$a);
 $_GET['id']=$b['6'];
$op=$obj->fetchById($_GET['id'],"unit_test_question","id");
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Edit Unit Test Question </h1>
                                <small>Edit question<a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="unit_question_list.php">Unit Test Question List</a></li>
                                    <li class="active">Edit Unit Test Question</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Edit Unit Test Question</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="<?php echo $base1; ?>edit_unit_test_sub.php" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="form-group">
												...
												<input type="hidden" class="form-control" name="limg" value="<?php echo $op['question'];?>">
													<!--<textarea  class="form-control" name="question" required><?php echo $op['question'];  ?></textarea>-->
