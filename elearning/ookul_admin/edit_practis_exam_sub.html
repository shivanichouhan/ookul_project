...
$rs=$obj->update_practis_question($exam_type_id,$exame_type,$subject,$type,$question,$option1,$option2,$option3,$option4,$solution,$question_image,$option_img1,$option_img12,$option_img3,$option_img4,$solution1,$answer,$id);
if($rs)
{
	
		echo ("<script LANGUAGE='JavaScript'>
          window.alert('Insert Success Full');
          window.location.href='gove_mlutipal_question_list.php';
       </script>");
}
else
{
...
echo ("<script LANGUAGE='JavaScript'>
          ...
          window.location.href='online_exam';
       </script>");
}
?>