                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Block Supervisor Report  List</li>
                                </ol>
                            </div>
...
?>
    	 ...
    	 <td><a href="upload/<?php echo $rs['document']; ?>"><i class="fa fa-download" aria-hidden="true" style="font-size: 50px;   color: #f74d59; "></i></a></td>
												  ...
												  <td><a href="block_supervioser_report.php?id=<?php echo $rs['id']; ?>"><button type="button" class="btn btn-danger" style="background-color: #ac08e4;
