...
<!-- /. main header -->
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="chapter.php"> Add Topic</a></li>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_chapter.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
        ...
        <script>
                function change_update(a,b)
                {
                       var http=new XMLHttpRequest();
						...
						http.open("GET","update_videos_3_status.php?id="+a+"&status="+b,true);
						http.send();
                }
            </script>
