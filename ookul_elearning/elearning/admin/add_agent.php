                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <small>Executive Supervisor <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                        ...
                        <div class="row">
						<form data-toggle="validator" action="add_agent_sub" method="post" enctype="multipart/form-data">
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Executive Supervisor</h4>
                                        </div>
                                    </div>
												...
												<?php
													...
													{	$i=0;
														...
														{	$i++;
															...
															?>
                                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['name'];  ?> | <?php echo $blk['block']; ?> </option>
													<?php } 
													}
													?>
                                                </select>
