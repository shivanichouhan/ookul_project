                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Replay User List</h1>
                                <small></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                   
                                    <li class="active">Replay User List</li>
                                </ol>
                            </div>
												...
												<?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php  echo $row['questions'];?></td>
														 ...
														 <td><img src="upload/<?php echo $row['img'];  ?>" style="width:150px;"></td>
														 <td><?php echo $row['date']; ?></td>
														
                                                       <td>
													   <a href="delete.php/<?php echo $row['id'];?>/contact_us/id/contactus" onClick="return confirm('Are you sure?');" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
