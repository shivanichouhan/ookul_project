...
include"menu.php"; ?>
<?php $con=$obj->fetchById($_GET['id'],"school_discount_code","id"); ?>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
<form data-toggle="validator" action="<?php echo $base; ?>add_user_dsicount_schl_sub.php" method="post" enctype="multipart/form-data">
...
<?php
$row=$obj->fetchAllDetailById(0,"user_register","pstatus");
 if($row){
