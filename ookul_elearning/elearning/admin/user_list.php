...
@keyframes fadeIn {
 ...
 <!-- /. main header -->
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													<td><img src="upload/<?php echo $row['picture']; ?>" style="width:50px; height:50px;"></td>				
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_rating.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Rating</a></li>
