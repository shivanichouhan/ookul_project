...
$rs=$obj->question_answer_solution($subject_id,$exam_type_id,$exame_type,$question,$option1,$option2,$option3,$option4,$solution,$question_image,$option_img1,$option_img12,$option_img3,$option_img4,$solution1,$answer);
if($rs)
{
	
		echo ("<script LANGUAGE='JavaScript'>
          window.alert('Insert Success Full');
          window.location.href='user_multiple_question_list';
       </script>");
}
else
{
