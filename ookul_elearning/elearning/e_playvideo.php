					...
					<div class="hs_blog_left_sidebar_main_wrapper">
						<div class="row">
								...
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										...
										<div class="prs_ms_scene_img_overlay">
											<ul>
												<li><a class="test-popup-link button" rel='external' href='https://www.youtube.com/watch?v=o3ka5fYysBM' title='title'><i class="flaticon-play-button"></i></a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										<iframe src="https://www.youtube.com/watch?v=o3ka5fYysBM"></iframe>
									</div>
									<div class="hs_blog_box1_cont_main_wrapper">
										<div class="hs_blog_cont_heading_wrapper">
											<ul>
...
the meaningful</h2>
    ...
    <div class="dropdown-menu">
    	<ul class="boxtext">
             <li class="boxtext1"> <a class="dropdown-item" href="#">Link</a></li>
             <li class="boxtext1"> <a class="dropdown-item" href="#">Link</a></li>
             <li class="boxtext1"> <a class="dropdown-item" href="#">Link</a></li>
             <li class="boxtext1"> <a class="dropdown-item" href="#">Link</a></li>
       </ul>
