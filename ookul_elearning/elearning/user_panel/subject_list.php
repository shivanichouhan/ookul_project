                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													{	$i=0;
														...
														{	$i++;
															$check=$obj->fetchById($row['class'],"class","id");
															?>
<tr>
<td><?php echo $check['class']; ?></td>
<td><?php echo $row['subject']; ?></td>

<td><img style="width:150px;" src="upload/<?php echo $row['icon1']; ?>"></td>
<td><img style="width:150px;" src="upload/<?php echo $row['banner1']; ?>"></td>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_subject.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/subject/id/subject_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
