...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Class List</h1>
                                <small>List All Class's</a></small>
                                <ol class="breadcrumb">
												...
												<?php
                                                    ...
                                                    <tr>
														...
														if($row['expiry_date']==$date){
															$rs00=$obj->expriy_date_update_status($row['id']);
														?>
														...
														<?php }
															...
															?>
															<button type="button" class="btn btn-success" style="background:#fe751e!important;
															border:1px solid #fe751e;">Active</button>
															<?php
														 } ?>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_class.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/class/id/class_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
