...
<td><?php echo $row['discount_price']; ?> </td>
 <td><a href="delete.php/<?php echo $row['id'];?>/gov_order/id/coupon_used" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></td>
