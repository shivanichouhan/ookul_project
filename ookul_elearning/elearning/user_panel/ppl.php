...
<!-- /. main header -->
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													<td><img src="upload/<?php  echo $row['thumbnail'];?>" style="width: 400px;
    height: 223px;"></td>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_ppl.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/parent_papular_video/id/ppl" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
