...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Demo Topic </h1>
                                <small>Add Demo Topic <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="demo_topic_list">Demo Topic List</a></li>
                                    <li class="active">Demo Topic</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Add Demo Topic</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="demo_topic_sub" method="post" enctype="multipart/form-data">
 ...
 function subj(a){
				// alert(a);
				 $("#chapter").load("demochapterAjax.php?id="+a);
				  }
				  </script>
