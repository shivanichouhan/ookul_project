<?php 
 ...
 include"isValid.php";
 $obj=new database();
 $admin=$obj->fetchById($_SESSION['admin_id'], "users","id");
 $web_info=$obj->fetchByIdTable("website_details");
   
 $base="https://educationdisha.in/elearning/user_panel/";
 $base1="https://educationdisha.in/elearning/user_panel/";
 $a="https://".$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"];
?>
