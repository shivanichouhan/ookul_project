...
<!-- Mirrored from thememinister.com/bootstrap-admin-template/template/theme/adminpage_v1.0/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Aug 2018 05:43:55 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="container-center">
                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3><img src="upload/abc.jpg" style="width: 150px; height: 90px; text-align:center; ">
                                   </h3></br>
                                <strong style="text-align:center; ">---User Login Form---</strong>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form action="loginSub.php" id="loginForm" method="post" novalidate>
                            <!--Social Buttons--> 
                           <!-- <div class="social">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="username" type="email" class="form-control" name="user_name" placeholder="Username" required>
                                </div>
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary pull-right" style="    background: -webkit-linear-gradient(left, #ff771c 0%, #ea00ca 50%,#9d09e9 90%);border:1px solid transparent;">Login</button>
                ...
                <div id="bottom_text">
                   <!-- Don't have an account? <a href="register.html">Sign Up</a><br>-->
                    Remind <a href="forget_password.php" style="color:white;text-shadow:none;">Password</a>
                </div>
            </div>
            </br>
            </br>
