...
include"menu.php"; ?> <!-- /. main header -->
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<img src="gov_upload/<?php echo $row['banner_image']; ?>" style="    width: 100px;   height: 100px;">
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_gov_subject.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
   <li><a href="delete.php/<?php echo $row['id'];?>/gov_subject/id/gov_subject_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
