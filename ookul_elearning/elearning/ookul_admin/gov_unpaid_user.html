                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1> Goverment Unpaid User List</h1>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Goverment Unpaid User List</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													$rs=$obj->fetchDetailById(0,$table,"pstatus");
													if($rs)
													{	$i=0;
								...
								$cop=$obj->fetchById($row['id'],"goverment_plan","price");
												...
												<td><?php echo $row['refferel_id']; ?></td>
													<td> <?php if($row['mac']=='') { ?> 
													...
													<td><img src="gov_upload/<?php echo $row['img']; ?>" style=" width: 50px;
    height: 50px;"></td>
