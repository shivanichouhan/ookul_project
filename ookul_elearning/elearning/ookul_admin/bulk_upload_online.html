...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1> Online Bulk Upload  </h1>
                                <small>Online   Bulk Upload  <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="user_multiple_question_list.php"> Online  Question Answer List</a></li>
                    ...
                    <form data-toggle="validator" action="bulk_online_exam_sub"  enctype="multipart/form-data" method="post">
											
											
											
									<div class="form-group">
									<label for="inputName" class="control-label">Pakage </label>
									
									<select class="form-control" id="exampleSelect1" name="package_id" onChange="msubject(this.value)" >
								...
								<label for="inputName" class="control-label">Exam</label>
									...
									<select class="form-control" id="sub" name="exam_id" >
												<?php
													$table='exam_names';
													$rs=$obj->fetchAllDetail($table);
													if($rs)
