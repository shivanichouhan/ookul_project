...
else
{
    ...
    { $tt=0;
        ...
        // 			{
                ...
                $us11=$obj->fetchByIdByStatus($days44,"routine","day","app_type",'2');
                // print_r($us11);
                // die();
                if($us11['description']=='')
                {
        	...
        	{	
        		...
        		{
                        if($tes['exam_name']){
                        	$dmem825=$tes['exam_name'];
                        }else{
                          $dmem825="No Record Found";  
                        }
                    	if($tes['exam_type']=='1')
                    	{
                    	    $dmem="Practice Exam";
        	...
        	{	
        		while($tes=mysqli_fetch_assoc($tes78))
        		{
                    ...
                    {
                        $dmem825="No Exam Available Todaye";
                        $dmem="No Exam Available Today";
                    }
                    ...
                    {
                        $response["exam_schadule"]=$dmem825;
                    }
                    if($dmem=='')
                    {
