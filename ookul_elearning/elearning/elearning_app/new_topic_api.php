...
$chapters=$obj->fetchDetailByIdByStatus($topic,"day_wise_topic","id","subject",$subject);
...
while($chapter=mysqli_fetch_assoc($chapters)){
	...
	//  $topics=$obj->fetchDetailById_newasc_007($chapter['id'],"gover_topic","topic");
	  ...
	  $topics=$obj->fetchDetailByIdByStatus($topic,"gover_topic","topic","subject",$subject);
