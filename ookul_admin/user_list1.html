...
include"menu.php"; ?> <!-- /. main header -->
    ...
    height: 50px;"></td>
													<!---<td> <?php echo $row['mac']; ?> <a href="mac_update.php?id=<?php echo $row['id'];?>&mac=<?php echo  base64_encode($row['mac']);?>">
													
													<button type="button" class="btn btn-danger"> Release</button></a></td>
