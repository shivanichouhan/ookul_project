...
<head>
	<title>MathType for TinyMCE | Math & Science</title>
					...
					<div class="wrs_col wrs_s12 wrs_m7 wrs_l8">
						<div class="wrs_col wrs_s12">
							...
							<div class="wrs_col wrs_s9 wrs_m10">
								<h1>MathType for TinyMCE</h1></div>
							</div>
						</div>
						<div class="wrs_col wrs_s12 wrs_m5 wrs_l4">
							<div class="wrs_row">
								<div class="wrs_col wrs_s3 wrs_center">
									<a href="http://www.wiris.com/plugins/demo/tinymce4/java" title="Java"><img id="java_logo" class="wrs_tech_logo" src="img/java_white.svg" alt="Java"></a>
								</div>
								<div class="wrs_col wrs_s3 wrs_center">
									<a href="http://www.wiris.com/plugins/demo/tinymce4/php" title="PHP"><img id="php_logo" class="wrs_tech_logo" src="img/php_white.svg" alt="PHP"></a>
								</div>
								<div class="wrs_col wrs_s3 wrs_center">
									<a href="http://www.wiris.com/plugins/demo/tinymce4/aspx" title=".NET"><img id="aspx_logo" class="wrs_tech_logo" src="img/net_white.svg" alt=".NET"></a>
								</div>
								<div class="wrs_col wrs_s3 wrs_center">
									<a href="http://www.wiris.com/plugins/demo/tinymce4/ruby" title="Ruby on Rails"><img id="ruby_logo" class="wrs_tech_logo" src="img/rails_white.svg" alt="Ruby on Rails"></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="wrs_content">
					<div class="wrs_row">
						<div class="wrs_col wrs_s12 wrs_m3">
							<h3>Language</h3>
							<ul>
								<li><a href="http://www.wiris.com/plugins/demo/tinymce4/java">Java</a></li>
								<li><a href="http://www.wiris.com/plugins/demo/tinymce4/php">PHP</a></li>
								<li><a href="http://www.wiris.com/plugins/demo/tinymce4/aspx">.NET</a></li>
								<li><a href="http://www.wiris.com/plugins/demo/tinymce4/ruby">Ruby</a></li>
							</ul>
						</div>
						<div class="wrs_col wrs_s12 wrs_m3">
							<h3>Links</h3>
							<ul>
								<li><a href="http://www.wiris.com/plugins/editors/download?filter=tinymce4">Download plugin</a></li>
								<li><a href="http://www.wiris.com/plugins/docs/demo-download?filter=tinymce4">Download this demo</a></li>
								<li><a href="http://www.wiris.com/plugins/docs/tinymce4">Documentation</a></li>
							</ul>
						</div>
						<div class="wrs_col wrs_s12 wrs_m3">
							<h3>Editors</h3>
