...
$b=explode('/',$a);
 $_GET['id']=$b['5'];
$top=$obj->fetchById($_GET['id'],"topic","id");
$sub=$obj->fetchById($top['subject'],"subject","id");
$chap=$obj->fetchById($top['chapter'],"chapter","id");
?>
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="topic_list">Topic List</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form  action="<?php echo $base1; ?>edit_topic_sub" method="post" enctype="multipart/form-data">
										<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" >
											...
											<div class="form-group">
                                                <label for="inputName" class="control-label">Subject</label>
													...
													<select class="form-control"  id="subject"  name="subject" required onChange="subj(this.value);">
									...
									<label for="inputName" class="control-label">Thumbnail</label>
										...
										<input type="hidden" class="form-control" name="limg5" value="<?php echo $top['thumbnail'];?>">
									</div>
											<div class="form-group">
 ...
 function clas(a){
				 //alert(a);
				 $("#subject").load("http://app.bongosikha.com/admin/subjectAjax.php?id="+a);
				  }
				  </script>
 ...
 function subj(a){
				// alert(a);
				 $("#chapter").load("http://app.bongosikha.com/admin/chapterAjax.php?id="+a);
				  }
				  </script>
