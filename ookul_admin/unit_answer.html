                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Unit Test Answer </h1>
                                <small>Add Unit Test Answer <a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord.php"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="unit_answer_list.php">Unit Test Answer List</a></li>
                                    <li class="active">Unit Test Answer</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Add Unit Test Answer</h4>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="unit_answer_sub.php" enctype="multipart/form-data" method="post">
											...
											<input type="file" class="form-control" id="inputName" name="answer" placeholder="answer" required>	
