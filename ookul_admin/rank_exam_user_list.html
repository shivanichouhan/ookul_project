                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													<td><a href="rank_view_history.php?user_id=<?php echo $row['id']; ?>">View History</a></td>
