...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Demo Multipal Question List</h1>
                                <small>List All Demo Multipal question's</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="multipal_question">Demo Multipal Question</a></li>
                                    <li class="active">Demo Multipal Question List</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Demo Multipal Question List</h4>
                                        </div>
                                    </div>
  ...
  <ul class="dropdown-menu">
    <li><a href="demo_edit_multiple_question.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/demo_mutiple/id/demo_mcq_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
