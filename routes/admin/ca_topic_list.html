...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Topic List</h1>
                                <small>List All Topic</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="ca_subject_topic">Add Topic</a></li>
                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													{	$i=0;
														...
														{	$i++;
															$yy=$obj->fetchById($row['subject'],"current_affairs_subject","id") 
															?>
                                                    <tr>
                                                        
														   <td><?php echo $yy['subject_name']; ?></td>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_ca_topic.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
   <li><a href="delete.php/<?php echo $row['id'];?>/ca_topic/id/ca_topic_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
