...
$rs=$obj->update_practis_question1($exam_type_id,$subject,$question,$option1,$option2,$option3,$option4,$solution,$question_image,$option_img1,$option_img12,$option_img3,$option_img4,$solution1,$answer,$id);
if($rs)
{
