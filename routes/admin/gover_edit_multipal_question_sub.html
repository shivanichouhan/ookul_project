...
$rs=$obj->update_goverment_question($exam_type_id,$class_id,$days_id,$type,$question,$option1,$option2,$option3,$option4,$question_image,$option_img1,$option_img12,$option_img3,$option_img4,$answer,$id);
if($rs)
{
