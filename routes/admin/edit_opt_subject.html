...
$b=explode('/',$a);
 $_GET['id']=$b['5']; 
$con=$obj->fetchById($_GET['id'],"optional_subject","id"); ?>
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="optional_subject_list.php">Subject List</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form action="<?php echo $base1; ?>edit_opt_subject_sub" method="post" enctype="multipart/form-data">
