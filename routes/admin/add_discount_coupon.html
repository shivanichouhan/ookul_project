...
<form data-toggle="validator" action="add_discount_coupon_sub.php" method="post" enctype="multipart/form-data">
			    ...
			    <input type="text" class="form-control" required="required" name="coupon" >
				</div>
			    ...
			    <input type="date" class="form-control" required="required" name="sdate" >
				</div>
				
				<div class="form-group">
				<label for="inputName" class="control-label">End Date</label>
			    <input type="date" class="form-control" required="required" name="edate" >
				</div>
