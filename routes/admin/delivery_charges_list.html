...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Delivery Charges List</h1>
                                <small>List All Delivery Charges</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="postal_charge">Add Delivery Charges</a></li>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_charges.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
