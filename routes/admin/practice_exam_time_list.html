...
?>          <div class="content-wrapper">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="add_practice_exam">Exam Schedule </a></li>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Practice Exam Schedule List</h4>
                                        </div>
                                    </div>
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_practice_exam_time.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/gove_exam/id/practice_exam_time_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
