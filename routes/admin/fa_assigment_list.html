                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Free Access Assigment  List</h1>
                                <small>Free Access Assigment's</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="fa_assigment">Free Access Assigment </a></li>
                                    <li class="active">Free Access Assigment  List</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Free Access Assigment   List</h4>
                                        </div>
                                    </div>
									...
									$op5=$obj->fetchById($row['topic'],"fag_topic","id");
...
<img src="gov_upload/<?php echo $row['option_img12'] ?>" >
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_fa_assigment.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/fa_assigment/id/fa_assigment_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
