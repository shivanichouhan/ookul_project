...
include"menu.php"; 
 $b=explode('/',$a);
 $_GET['id']=$b['5'];
$rs007=$obj->fetchById($_GET['id'],"price_plan_image","id");
?>            <!-- /.content-wrapper -->
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="edit_price_plan_sub.php" method="post"  enctype="multipart/form-data">
					                   <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                                           
										   <div class="form-group">
                                                <label for="inputName" class="control-label">Image</label>
                                                <input type="file" class="form-control" id="inputName" name="image" placeholder="image" value="<?php echo $rs007['image']; ?>"required>
                                            </div>
                                            <div class="form-group">
