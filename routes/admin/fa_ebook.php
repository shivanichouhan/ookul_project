                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="fa_ebook_list">E-Book List</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="fa_ebook_sub.php" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
									<label for="inputName" class="control-label">Document (Only Pdf Formate)</label>
