                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="add_discount_coupon_schl.php"> Add Discount Coupon</a></li>
...
<li><a href="edit_discount_coupon_schl.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
<li><a href="adduser_discount_coupon_schl.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add User</a></li>
<li><a href="delete.php/<?php echo $row['id'];?>/discount_code/id/school_discount_code" onClick="return confirm('Are you sure?');">
