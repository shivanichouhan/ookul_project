                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1> Goverment Paid User List</h1>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Goverment Paid User List</h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													$rs=$obj->fetchDetailById(1,$table,"pstatus");
													if($rs)
													{	$i=0;
								...
								$cop=$obj->fetchById($row['id'],"goverment_plan","price");
													...
													<td><?php echo $ss['language']; ?></td>
													 <td><?php echo $cop['price']; ?></td>

													<td> <?php if($row['mac']=='') { ?> 
													<button type="button" class="btn btn-success"> Released</button>
													<?php } else { ?>
													<a href="mac_update_goverment.php?id=<?php echo $row['id'];?>&mac=<?php echo  base64_encode($row['mac']);?>">
													
													<button type="button" class="btn btn-danger"> Release</button></a>
													<?php } ?>
													</td>
													<td><?php  $row['fcm_token']; ?></td>
													<td><img src="upload/<?php echo $row['img']; ?>" style=" width: 50px;
    height: 50px;"></td>
