                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
                                                    ...
                                                    <td>
                                                        <?php if($row['img']=='') {
                                                            ?>
                                                            <img src="gov_upload/student.png" style="width: 100px;height: 100px;">

                                                            <?php
                                                        }
                                                        else
                                                        { ?>
                                                        <img src="../gov_upload/<?php echo $row['img']; ?>" style="width: 100px;height: 100px;">
                                                        <?php } ?>
                                                    </td>
													...
													<td><a href="practise_view_history.php?user_id=<?php echo $row['id']; ?>">View History</a></td>
