...
include"menu.php"; ?> <!-- /. main header -->
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Feedback List</h1>
                                <small>List Feedback Update</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="reply_update">Feedback Update</a></li>
                                    <li class="active">Feedback Update List</li>
                                </ol>
                            </div>
                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													{	$i=0;
													 ...
													 $users=$obj->fetchById($row['user_id'], "register","id");
															?>
                                                    <tr>
														<td><?php echo $i; ?></td>
  ...
  <ul class="dropdown-menu">
    <li><a href="reply_update.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Reply</a></li>
