...
$b=explode('/',$a);
 ...
 $ass=$obj->fetchById($_GET['id'],"ca_topic","id");
?>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        <form data-toggle="validator" action="<?php echo $base1; ?>edit_ca_topic_sub" method="post" enctype="multipart/form-data">
										<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
											...
											<div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="inputName" name="topic" placeholder="Topic" value="<?php echo $ass['topic']; ?>" required>
											</div>
											<!--<div class="form-group">-->
