...
include"menu.php"; ?> <!-- /. main header -->
            ...
            <div class="content-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Subject  List</h1>
                                <small>All Subject List</a></small>
                                <ol class="breadcrumb">
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
												...
												<?php
													...
													$rs=$obj->fetchAllDetailByorder("add_subject_exam");
													if($rs)
													{	$i=0;
                ...
                <td>
				<a href="edit_subject_new_list.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>
				</td>
                                                    </tr>
															<?php 
														}
