                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Free Access Practise List</h1>
                                <small>List All Rank  Online's</a></small>
                                <ol class="breadcrumb">
                                    <li><a href="deshabord"><i class="pe-7s-home"></i> Home</a></li>
                                    <li><a href="online_exam.php">Online Rank  Question</a></li>
                                    <li class="active">Online Rank  Question List</li>
                                </ol>
                            </div>
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4> Online Rank  Question List</h4>
                                        </div>
                                    </div>
...
<img src="gov_upload/<?php echo $row['option_img12'] ?>" >
  ...
  <ul class="dropdown-menu">
    <li><a href="edit_fa_online_exam.php/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a></li>
    <li><a href="delete.php/<?php echo $row['id'];?>/fa_multiple_question/id/fa_practise_list" onClick="return confirm('Are you sure?');"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a></li>
