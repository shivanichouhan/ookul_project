                                            ...
                                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                                <thead>
                                                    <tr>
														...
														<th>Email</th>
														<th>Mobile Number</th>
														<th>Student Register Mobile Number</th>
														<th>Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
												<?php
													...
													<td><?php echo $row['student_mobile']; ?></td>
														...
														<td><a href="view_student.php?student_mobile=<?php echo $row['student_mobile']; ?>"><button  class="btn btn-primary" style="  background: -webkit-linear-gradient(left, #ff771c 0%, #ea00ca 50%,#9d09e9 90%);
    border: 1px solid transparent;
    font-weight: 700;">View</button></a></td>
                                                    </tr>
															<?php 
														}
													} ?>
