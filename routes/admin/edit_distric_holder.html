                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <small>Edit Distric Holder<a href="https://1000hz.github.io/bootstrap-validator/" target="_blank"></a> </small>
                                <ol class="breadcrumb">
                        	...
                        	<form data-toggle="validator" action="<?php echo $base1; ?>edit_distric_sub.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4>Edit Distric Holder</h4>
                                        </div>
                                    </div>
									<?php $aa=$obj->fetchById($_GET['id'],"distric_holder","id");
										...
										<div class="form-group">
                                         ...
                                         <select class="form-control" id="exampleSelect1" name="distric_id" >
												...
												<?php
													...
													$rs=$obj->fetchAllDetailByStatus_distric($table);
													if($rs)
													{	$i=0;
												...
												// 			$blk=$obj->fetchById($row['block_id'],"block","id");
															?>
                                                    <option value="<?php echo $row['id']; ?>" <?php if($row['id']==$aa['amount']){ echo 'selected';} ?>><?php echo $row['city'];  ?>  </option>
													<?php } 
													}
													?>
                                                </select>
